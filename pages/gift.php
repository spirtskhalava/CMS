  ...
  <body class="app">
    ...
    <div class="app-wrapper">
      <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container">
          <form action="add-gifts.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <select id="carDropdown" name="car_id" class="form-select">
                <option value="">Select a car</option> <?php foreach ($cars as $car): ?> <option value="
			<?php echo htmlspecialchars($car['id']); ?>"> <?php echo htmlspecialchars($car['make'] . ' ' . $car['model'] . ' ' . $car['vin']); ?> </option> <?php endforeach; ?>
              </select>
            </div>
            <div class="mb-3">
