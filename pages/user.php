    ...
    <div class="app-wrapper">
      <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
          <button type="button" id="add_user_record" class="btn btn-primary mb-2">Add User</button>
                    ...
                    <div class="table-responsive">
                      <table class="table app-table-hover mb-0 text-left">
                        ...
                        <tbody> <?php
                            ...
                            <td class="cell">
                              <span class="truncate"> <?php echo $row["role"]; ?> </span>
                            </td>
                            <td class="cell"> <?php echo $row["name"]; ?> </td>
                            <td class="cell">
                              <span class="note"> <?php echo $row["username"]; ?> </span>
                            </td>
                            <td class="cell">
                              <a class="btn-sm app-btn-secondary edit" data-id="<?php echo $row["id"]; ?>" href="#">Edit </a>
                            </td>
                            <td class="cell">
                              <a class="btn-sm app-btn-secondary delete" data-id="<?php echo $row["id"]; ?>" href="#">Delete </a>
                            </td>
                          </tr> <?php }
                                           ?> </tbody>
                      </table>
