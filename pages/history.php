                      ...
                      <table class="table app-table-hover mb-0 text-left">
                        ...
                        <tbody> <?php
                                ...
                                if($_SESSION['role'] == 'dealer') {
                                    $sql = "
                                        SELECT logs.*, users.username FROM logs LEFT JOIN users ON logs.user_id = users.id WHERE action='PAYMENT' AND logs.user_id = '$user_id'
                                    ";
                                } else {
                                    $sql = "
                                        SELECT logs.*, users.username FROM logs LEFT JOIN users ON logs.user_id = users.id WHERE action='PAYMENT'
                                    ";
                                }
